(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		define("vueCoverVideoComponent", [], factory);
	else if(typeof exports === 'object')
		exports["vueCoverVideoComponent"] = factory();
	else
		root["vueCoverVideoComponent"] = factory();
})(this, function() {
...
/***/ function(module, exports, __webpack_require__) {
	...
	__vue_options__.__file = "/Users/reinhard/Work/Coachella/Site/wp-content/themes/coachella2017/src/workbench/vue-cover-video-component/index.vue"
	...
	if (false) {(function () {
	  ...
	  module.hot.accept()
	  if (!module.hot.data) {
	    hotAPI.createRecord("data-v-531a4ac1", __vue_options__)
	  } else {
	    hotAPI.reload("data-v-531a4ac1", __vue_options__)
	  }
	})()}
...
/***/ function(module, exports, __webpack_require__) {
	...
	var defer, isString, win;

	win = __webpack_require__(4);

	defer = __webpack_require__(7);

	isString = __webpack_require__(10);

	module.exports = {
	  components: {
	    'media-loader': __webpack_require__(12)
	  },
	  ...
	  props: {
	    ...
	    autoload: {
	      ...
	      validator: function(value) {
	        return value === 'visible' || value === 'revealed' || value === 'hover' || value === true || value === false;
	      }
	    },
	    autoplay: {
	      "default": true,
	    ...
	    autopause: {
	      "default": 'visible',
	      validator: function(value) {
	        return value === 'visible' || value === 'revealed' || value === 'hover' || value === false;
	      }
	    },
	    requireAutoplay: {
	      "default": true,
	  ...
	  created: function() {
	    return this.inViewportOnce = false;
	  },
	  ready: function() {
	    if ('hover' === this.autoload || 'hover' === this.autopause) {
	      this.addHoverListeners();
	    }
	    if (this.inViewportProp('autoload')) {
	      return this.loadWhenVisible();
	    } else if (this.autoload === true) {
	      return this.load();
	    }
	  },
	  destroyed: function() {
	  ...
	  methods: {
	    addHoverListeners: function() {
	      ...
	      dispatcher = (ref = this.hoverDispatcher) != null ? ref : this.$el;
	      dispatcher.addEventListener('mouseenter', this.onMouseenter);
	      return dispatcher.addEventListener('mouseleave', this.onMouseleave);
	    },

	    /*
	    		 * Triggers
	     */
	    loadWhenVisible: function() {
	      var unwatch;
	      return unwatch = this.$watch(this.inViewportProp('autoload'), function(visible) {
	        if (!visible) {
	          return;
	        }
	        if (unwatch) {
	    ...
	    loadVideo: function() {
	      ...
	      this.vid = this.renderVideo(this.video);
	      this.vid.addEventListener('loadedmetadata', this.onAspectData);
	      this.vid.addEventListener('timeupdate', this.canPlay);
	      this.$els.video.appendChild(this.vid);
	      if (this.autoplay === true) {
	        this.play();
	      }
	      if (prop = this.inViewportProp('autopause')) {
	        return this.$watch(prop, this.toggleOnViewport, {
	          immediate: true
	        });
	      } else if (this.autopause === 'hover') {
	        if (this.mouseover) {
	          return this.play();
	        }
	      }
	    },
	    renderVideo: function(html) {
	      var $html;
	      $html = $(html);
	      if (this.loop) {
	        $html.attr('loop', true);
	      ...
	      if (this.autoplay === true) {
	        $html.attr('autoplay', true);
	      }
	      if (this.mute) {
	        $html.attr('muted', true);
	      }
	      $html.attr('preload', 'auto');
	      return $html[0];
	    },
	    canPlay: function(e) {
	      if (this.vid.currentTime < 0.2) {
	        return;
	      }
	      this.vid.removeEventListener('timeupdate', this.canPlay);
	    ...
	    loadFallback: function() {
	      return this.requestFallback = true;
	    },

	    /*
	    		 * Cover layout
	     */
	    onAspectData: function(e) {
	      this.vid.removeEventListener('loadedmetadata', this.onAspectData);
	      return this.captureAspect();
	    },
	    captureAspect: function(e) {
	      this.videoAspect = this.vid.videoWidth / this.vid.videoHeight;
	    ...
	    onResize: function(e) {
	      ...
	      return this.containerAspect = this.$el.clientWidth / this.$el.clientHeight;
	    },
	    ...
	    removeHoverListeners: function() {
	      var dispatcher, ref;
	      dispatcher = (ref = this.hoverDispatcher) != null ? ref : this.$el;
	      dispatcher.removeEventListener('mouseenter', this.onMouseenter);
	      return dispatcher.removeEventListener('mouseleave', this.onMouseleave);
	    },
	    destroyVideo: function() {
	      ...
	      this.vid.removeEventListener('loadedmetadata', this.onAspectData);
	      this.vid.removeEventListener('timeupdate', this.canPlay);
	      return this.unloadVideo();
	    },
	    unloadVideo: function() {
	      if (document.body.contains(this.vid)) {
	        return setTimeout(this.unloadVideo, 50);
	      }
	      this.vid.pause();
	      this.vid.src = '';
	      return this.vid.load();
	    },

	    /*
	    		 * Controlling video API
	     */
	    toggleOnViewport: function(isIn) {
	      if (isIn) {
	        return this.play();
	      } else {
	        return this.pause();
	    ...
	    inViewportProp: function(prop) {
	      switch (this[prop]) {
	        case 'visible':
	          return 'inViewport';
	        case 'revealed':
	          return 'inViewportEntirely';
	      }
	    }
	  },
	  watch: {
	    playing: function(playing) {
	      ...
	      if (playing) {
	        ...
	        return this.vid.pause();
	      }
	    },
	    mouseover: function(hovered) {
	      if (hovered) {
	        if (this.autoload === 'hover') {
	          this.load();
	        }
	        if (this.autopause === 'hover') {
	          return this.play();
	        }
	      } else {
	        if (this.autopause === 'hover') {
	  ...
	  computed: {
	    trim: function() {
	      if (!(this.videoAspect && this.containerAspect)) {
	        return;
	      }
	      if (this.containerAspect > this.videoAspect) {
	        return 'letterbox';
	      } else {
	        return 'pillarbox';
	      }
	    ...
	    shouldLoadVideo: function() {
	      return !!(this.video && (this.supportsAutoplay || !this.requireAutoplay));
	    },
	    supportsAutoplay: function() {
	      return !navigator.userAgent.match(/Mobile|Android|BlackBerry/i);
	    },
	    posterSrc: function() {
	      if (this.shouldLoadVideo || this.fallbackIsGif || !this.fabllbackUrl) {
	        return this.poster;
	      } else {
	    ...
	    fallbackSrc: function() {
	      if (this.fallbackIsGif && !this.shouldLoadVideo) {
	        return this.fallback;
	      }
	    },
	    fallbackIsGif: function() {
	      if (!this.fabllbackUrl) {
	        return false;
	      }
	      return !!this.fabllbackUrl.match(/\.gif$/i);
	    },
	    fabllbackUrl: function() {
	      if (!this.fallback) {
	        return null;
	      }
	      if (isString(this.fallback)) {
	        return this.fallback;
	      } else {
...
/***/ function(module, exports, __webpack_require__) {
	...
	WindowEventMediator = (function() {
	  ...
	  WindowEventMediator.prototype.off = function(event, callback, options) {
	    ...
	    if (options != null) {
	      ...
	      if (this.handlers[event][key] != null) {
	        return _.remove(this.handlers[event][key], function(cbs) {
	          return cbs.original === callback;
	        });
	      }
	    } else {
	      return _.each(this.handlers[event], function(arr) {
	        return _.remove(arr, function(cbs) {
	          return cbs.original === callback;
	        });
	      });
	    }
	  ...
	  WindowEventMediator.prototype.fire = function(e) {
	    return _.forEachRight(this.handlers[e.type], function(bag) {
	      return _.forEachRight(bag, function(cbs) {
	        cbs.modified(e);
	        return true;
	      });
	    });
...
/***/ function(module, exports, __webpack_require__) {
	...
	var baseDelay = __webpack_require__(8),
...
/***/ function(module, exports, __webpack_require__) {
	...
	isHires = __webpack_require__(13);
	...
	module.exports = {
	  ...
	  update: function(media) {
	    this.media = media;
	    $(this.el).addClass('media-loader');
	    if (this.media) {
	      return this.determineMediaType();
	    }
	  },
	  unbind: function() {
	    return $(this.el).next('.media-loader-progress').remove();
	  },

	  /*
	  	The HTML element type determines how to apply the loaded media
	   */
	  determineMediaType: function() {
	    var elType;
	    switch (elType = this.el.nodeName) {
	      case 'IMG':
	  ...
	  getImageSize: function() {
	    var ref, size, width, win;
	    if (typeof this.media === 'string') {
	      return this.media;
	    }
	    if (this.modifiers["native"]) {
	      if (isHires) {
	        return this.media.l2x;
	      } else {
	        return this.media.l;
	      }
	    }
	    win = $win.outerWidth();
	    ref = _.omit(this.breakpoints, 'xl');
	    for (size in ref) {
	      width = ref[size];
	      if (win <= width) {
	        if (isHires) {
	          return this.media[size + '2x'];
	        } else {
	    ...
	    if (isHires) {
	      return this.media.xl2x;
	    } else {
	      return this.media.xl;
	    }
	  },
	   ...
	   */
	  loadImage: function(background) {
	    var img, imgSrc;
	    if (background == null) {
	      background = false;
	    }
	    if (!(imgSrc = this.getImageSize())) {
	      return;
	    }
	    img = new Image();
	    img.src = imgSrc;
	    if (background) {
	      $(this.el).after("<div class='media-loader-progress'></div>");
	    }
	    _.delay((function(_this) {
	      return function() {
	        $(_this.el).addClass('media-loading');
	        return _this.vm.$dispatch('mediaLoading', _this.el);
	      };
	    })(this));
	    return img.onload = (function(_this) {
	      return function(e) {
	        var $el, attribute, styles;
	        if (!_this.el) {
	          return;
	        }
	        $el = $(_this.el);
	        if (background) {
	          ...
	          if (_this.media.bkgd_pos) {
	            styles.backgroundPosition = _this.media.bkgd_pos;
	          }
	          $el.css(styles);
	        } else {
	          $el.attr('src', imgSrc);
	        ...
	        if (_this.media.title) {
	          attribute = background ? 'aria-title' : 'alt';
	          $el.attr(attribute, _this.media.title);
	        }
	        return setTimeout(function() {
	          ...
	          if (_this.vm) {
	            return _this.vm.$dispatch('mediaLoaded', _this.el);
	          }
	        }, 50);
	      };
	    })(this);
...
/***/ function(module, exports) {
	 ...
	 * vp - the viewport
	 */
	var inViewport, inViewportEntirely, nope;
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports={render:function (){var _vm=this;
	  return _vm._h('div', {
	    ...
	    class: [_vm.trim, _vm.playable && _vm.trim ? "visible" : ""]
	  }, [_vm._t("prepend"), (_vm.posterSrc) ? _vm._h('div', {
	    directives: [{
	      name: "media-loader",
	      rawName: "v-media-loader",
	      value: (_vm.posterSrc),
	      expression: "posterSrc"
	    }],
	    ref: "poster",
	    staticClass: "bkgd"
	  }) : _vm._e(), (_vm.shouldLoadVideo) ? _vm._h('div', {
	    ref: "video",
	    staticClass: "video"
	  }) : _vm._e(), (_vm.fallbackSrc && _vm.requestFallback) ? _vm._h('div', {
	    directives: [{
	      name: "media-loader",
	      rawName: "v-media-loader",
	      value: (_vm.fallbackSrc),
	      expression: "fallbackSrc"
	    }],
	    ref: "fallback",
	...
	if (false) {
	  module.hot.accept()
	  if (module.hot.data) {
	     require("vue-hot-reload-api").rerender("data-v-531a4ac1", module.exports)
	  }
	}
